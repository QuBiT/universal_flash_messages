...
This gem provides a convinient and consistant way to add flash messages inside your controllers and views.
...
This gem is hosted on RubyGems.org: http://rubygems.org/gems/universal_flash_helper
...
Only those types you specified are recogniced by this gem.
If you have removed (by not adding it to the array) :success you will be no longer able to use add_success and if you use it, it will result in an method not found error.
